...
Each child must have at least one candy.  //至少一颗糖
Children with a higher rating get more candies than their neighbors.  //高等级的拿的更多
...
题解：
 ...
 这道题和Trapping water那个是一样的想法，因为无论是水坑还是得到糖的小朋友，影响因素都不只一边，
 都是左右两边的最小值/最大值来决定的。
